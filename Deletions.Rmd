...
##data cleanup tidyverse select column to join the 2 tables 
...
View(b)
d <- unique(b$Origin)
##use data table <- leaflet tutorial to save as a data table 

## want a data table of just the origins and destinations from alldata in the table of airport data (cleaning up that data)
##index or select verb in tidyverse , use unique after creating a separate data table with just the column origin, then doing a left hand join with the airports data. 
...
##LeafletPopups from the Airport Data 
